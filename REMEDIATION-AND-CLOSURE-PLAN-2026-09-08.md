...
**Plan date:** 2026-09-08 **Revision:** 5 — incremental merge and pre-HIL deployment policy recorded
...
| ------- | -------: | ------------- | ----------- | ----------------------------------------- | -------------------------------------------------------------- |
| BASE-01 |       P0 | OPEN          | Agent       | Independent agent                         | Approve findings/evidence schema before repository integration |
...
| GAP-04  |       P0 | OPEN          | Agent       | Independent agent                         | Approve capability/target model                                |
| GAP-05  |       P0 | OPEN          | Agent       | Independent agent                         | Approve unknown/failure semantics                              |
| GAP-06  |       P0 | OPEN          | Agent       | Independent agent                         | Approve status semantics and controlling ADR                   |
