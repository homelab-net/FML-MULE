# Channel plan - United States, 902-928 MHz

This file is seeded and unfilled. It will hold the region's channel plan.

**Status: `TBD`.** No channel plan has been selected for this region. A channel
plan is a regulatory statement, and inventing one would be exactly the kind of
plausible-looking fabrication this repository forbids. See `TBR-RF-02`.
