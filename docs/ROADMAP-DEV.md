...
dated 2026-09-24 finds that no existing representation carries those
sentences. `FML-ADR-083` is `PROPOSED` and not accepted, so the criteria stay
on the open trade. Criteria 42-45 and 47
