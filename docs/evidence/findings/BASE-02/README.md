...
mutation score, generated-output recovery, and temporary fault result.
`closure.md` binds that artifact to the implementation commit and records the
independent P0 reproduction and approval.
