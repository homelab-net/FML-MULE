# Evidence for TBR-SEC-01

**Trade:** Protected storage unlock

**Trade file:** `docs/trades/TBR-SEC-01-protected-storage-unlock.md`
...
**Requires hardware:** The analysis against capture scenarios is the larger half and needs no hardware.
