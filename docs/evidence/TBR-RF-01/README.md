# Evidence for TBR-RF-01

**Trade:** High-rate mesh implementation
...
**Requires hardware:** Requires at least two nodes with the candidate high-rate radio. The prototype
