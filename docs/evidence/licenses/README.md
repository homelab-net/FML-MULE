...
This directory holds license texts conveyed with archived third-party
snapshots. It is not the license of FML-MULE. Documentation in this
repository stays CC BY 4.0. Source code stays Apache-2.0. See `LICENSE`
and `LICENSE-DOCS`.
