# Evidence for TBR-CARRIER-01

**Trade:** Carrier board justification

**Trade file:** `docs/trades/TBR-CARRIER-01-carrier-board-justification.md`

**Priority:** 16 of 16 (SAD v0.31 section 30.2). **Function owner:** Builder + Power + RF.
**Named owner:** `TBD-SRR`.
