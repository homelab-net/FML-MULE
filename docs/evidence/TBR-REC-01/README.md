# Evidence for TBR-REC-01

**Trade:** Rollback implementation

**Trade file:** `docs/trades/TBR-REC-01-rollback-implementation.md`

**Priority:** 13 of 16 (SAD v0.31 section 30.2). **Function owner:** Platform + CM.
**Named owner:** `TBD-SRR`.
