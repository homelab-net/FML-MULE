# Evidence for TBR-HW-01

**Trade:** Primary compute hardware block

**Trade file:** `docs/trades/TBR-HW-01-primary-compute-hardware-block.md`

**Priority:** 7 of 16 (SAD v0.31 section 30.2). **Function owner:** Systems + Builder.
**Named owner:** `TBD-SRR`.
