# Evidence for TBR-PWR-01

**Trade:** Endurance and battery mass

**Trade file:** `docs/trades/TBR-PWR-01-endurance-and-battery-mass.md`

**Priority:** 1 of 16 (SAD v0.31 section 30.2). **Function owner:** Power/Mechanical.
**Named owner:** `TBD-SRR`.
...
**Requires hardware:** Requires an instrumented prototype. SAD section 25.7 directs that the same rig
