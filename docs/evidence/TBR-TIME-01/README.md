# Evidence for TBR-TIME-01

**Trade:** Clock holdover and skew tolerance

**Trade file:** `docs/trades/TBR-TIME-01-clock-holdover-and-skew-tolerance.md`

**Priority:** 5 of 16 (SAD v0.31 section 30.2). **Function owner:** Platform + Security.
**Named owner:** `TBD-SRR`.
