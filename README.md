...
2. **[`docs/conops/`](docs/conops/)** — CONOPS v1.2, what the system is for.
...
| Path | Contents |
| --- | --- |
| `docs/` | The design record: CONOPS v1.2, SAD v0.32, the decision and trade registers, verification, evidence, fork ledger, change requests. |
