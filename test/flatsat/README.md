...
| `FakeTranslation` | `mule.loops.TranslationReadings` | What batctl reports about who is reachable where, including being unreadable | batman-adv's ageing; a real table expires entries, and a stale one is the innocent explanation for a signature | `TBR-NET-01` |
